...
2. `printf ("%.*s", (i * 2 + 1), "******************************");`
	This is a similar piece of code, that prints `2i + 1` stars to the screen. i starts at 0, so the first line will just be one star, but as i increases, 2 more stars will be added to each line.
3. `printf("\n");`
