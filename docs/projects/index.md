...
featured-image: programming-projects-in-every-language.png
...
- [File Input Output](https://sampleprograms.io/projects/file-input-output)
...
- [Longest Common Subsequence](https://sampleprograms.io/projects/longest-common-subsequence)
- [Longest Palindromic Substring](https://sampleprograms.io/projects/longest-palindromic-substring)
- [Longest Word](https://sampleprograms.io/projects/longest-word)
- [Maximum Array Rotation](https://sampleprograms.io/projects/maximum-array-rotation)
- [Maximum Subarray](https://sampleprograms.io/projects/maximum-subarray)
- [Merge Sort](https://sampleprograms.io/projects/merge-sort)
- [Minimum Spanning Tree](https://sampleprograms.io/projects/minimum-spanning-tree)
- [Palindromic Number](https://sampleprograms.io/projects/palindromic-number)
- [Prime Number](https://sampleprograms.io/projects/prime-number)
- [Quick Sort](https://sampleprograms.io/projects/quick-sort)
- [Quine](https://sampleprograms.io/projects/quine)
- [Remove All Whitespace](https://sampleprograms.io/projects/remove-all-whitespace)
- [Reverse String](https://sampleprograms.io/projects/reverse-string)
