...
Welcome to the [Josephus Problem](/projects/josephus-problem) in [Beef](/languages/beef) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Josephus Problem in [Beef](/languages/beef) was written by:
