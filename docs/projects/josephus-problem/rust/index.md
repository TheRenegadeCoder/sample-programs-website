...
Welcome to the [Josephus Problem](https://sampleprograms.io/projects/josephus-problem) in [Rust](https://sampleprograms.io/languages/rust)! Here, you'll find the source code for this program as well as a description of how the program works.
