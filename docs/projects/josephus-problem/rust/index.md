...
Welcome to the [Josephus Problem](/projects/josephus-problem) in [Rust](/languages/rust) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Josephus Problem in [Rust](/languages/rust) was written by:
