...
Welcome to the [Josephus Problem](/projects/josephus-problem) in [AWK](/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Josephus Problem in [AWK](/languages/awk) was written by:
