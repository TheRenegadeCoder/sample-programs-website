...
Welcome to the [Josephus Problem](/projects/josephus-problem) in [Pascal](/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Josephus Problem in [Pascal](/languages/pascal) was written by:
