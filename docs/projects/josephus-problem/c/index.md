...
Welcome to the [Josephus Problem](/projects/josephus-problem) in [C](/languages/c) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Josephus Problem in [C](/languages/c) was written by:
