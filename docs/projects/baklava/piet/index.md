...
- sources/programs/baklava/piet/how-to-implement-the-solution.md
- sources/programs/baklava/piet/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Baklava](https://sampleprograms.io/projects/baklava) in [Piet](https://sampleprograms.io/languages/piet)! Here, you'll find the source code for this program as well as a description of how the program works.
