...
Welcome to the [Baklava](/projects/baklava) in [Opa](/languages/opa) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [Opa](/languages/opa) was written by:
