...
Welcome to the [Baklava](/projects/baklava) in [Smalltalk](/languages/smalltalk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [Smalltalk](/languages/smalltalk) was written by:
