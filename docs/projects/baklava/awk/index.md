...
Welcome to the [Baklava](/projects/baklava) in [AWK](/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [AWK](/languages/awk) was written by:
