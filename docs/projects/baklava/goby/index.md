...
Welcome to the [Baklava](https://sampleprograms.io/projects/baklava) in [Goby](https://sampleprograms.io/languages/goby)! Here, you'll find the source code for this program as well as a description of how the program works.
