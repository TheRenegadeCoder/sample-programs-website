...
Welcome to the [Baklava](https://sampleprograms.io/projects/baklava) in [Prolog](https://sampleprograms.io/languages/prolog)! Here, you'll find the source code for this program as well as a description of how the program works.
