...
Welcome to the [Baklava](/projects/baklava) in [Prolog](/languages/prolog) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [Prolog](/languages/prolog) was written by:
