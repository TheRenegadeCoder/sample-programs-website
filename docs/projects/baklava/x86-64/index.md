...
- sources/programs/baklava/x86-64/how-to-implement-the-solution.md
- sources/programs/baklava/x86-64/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Baklava](https://sampleprograms.io/projects/baklava) in [x86-64](https://sampleprograms.io/languages/x86-64)! Here, you'll find the source code for this program as well as a description of how the program works.
