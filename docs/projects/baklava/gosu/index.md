...
Welcome to the [Baklava](/projects/baklava) in [Gosu](/languages/gosu) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [Gosu](/languages/gosu) was written by:
