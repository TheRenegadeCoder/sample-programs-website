...
Welcome to the [Baklava](https://sampleprograms.io/projects/baklava) in [Mirth](https://sampleprograms.io/languages/mirth)! Here, you'll find the source code for this program as well as a description of how the program works.
