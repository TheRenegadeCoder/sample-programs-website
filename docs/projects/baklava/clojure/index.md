...
Welcome to the [Baklava](/projects/baklava) in [Clojure](/languages/clojure) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [Clojure](/languages/clojure) was written by:
