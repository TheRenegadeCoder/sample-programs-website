...
Welcome to the [Baklava](https://sampleprograms.io/projects/baklava) in [C2](https://sampleprograms.io/languages/c2)! Here, you'll find the source code for this program as well as a description of how the program works.
