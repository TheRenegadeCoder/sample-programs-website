...
Welcome to the [Baklava](/projects/baklava) in [PureScript](/languages/purescript) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [PureScript](/languages/purescript) was written by:
