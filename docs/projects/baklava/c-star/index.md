...
Welcome to the [Baklava](/projects/baklava) in [C\*](/languages/c-star) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [C\*](/languages/c-star) was written by:
