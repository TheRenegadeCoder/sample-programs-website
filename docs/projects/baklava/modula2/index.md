...
Welcome to the [Baklava](/projects/baklava) in [Modula-2](/languages/modula2) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [Modula-2](/languages/modula2) was written by:
