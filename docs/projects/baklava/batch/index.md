...
Welcome to the [Baklava](/projects/baklava) in [Batch](/languages/batch) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Baklava in [Batch](/languages/batch) was written by:
