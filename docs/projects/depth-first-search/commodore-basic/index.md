...
Welcome to the [Depth First Search](/projects/depth-first-search) in [Commodore BASIC](/languages/commodore-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Depth First Search in [Commodore BASIC](/languages/commodore-basic) was written by:
