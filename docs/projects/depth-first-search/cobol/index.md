...
Welcome to the [Depth First Search](/projects/depth-first-search) in [COBOL](/languages/cobol) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Depth First Search in [COBOL](/languages/cobol) was written by:
