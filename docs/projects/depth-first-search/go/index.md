...
Welcome to the [Depth First Search](https://sampleprograms.io/projects/depth-first-search) in [Go](https://sampleprograms.io/languages/go)! Here, you'll find the source code for this program as well as a description of how the program works.
