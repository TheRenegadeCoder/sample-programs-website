...
- sources/programs/depth-first-search/python/how-to-implement-the-solution.md
- sources/programs/depth-first-search/python/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Depth First Search](/projects/depth-first-search) in [Python](/languages/python) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Depth First Search in [Python](/languages/python) was written by:
