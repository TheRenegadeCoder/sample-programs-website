...
- sources/programs/depth-first-search/awk/how-to-implement-the-solution.md
- sources/programs/depth-first-search/awk/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Depth First Search](https://sampleprograms.io/projects/depth-first-search) in [AWK](https://sampleprograms.io/languages/awk)! Here, you'll find the source code for this program as well as a description of how the program works.
