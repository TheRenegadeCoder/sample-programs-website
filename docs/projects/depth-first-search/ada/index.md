...
- ada
- depth-first-search
title: Depth First Search in Ada
title1: Depth First
title2: Search in Ada
---
...
- sources/programs/depth-first-search/ada/how-to-implement-the-solution.md
- sources/programs/depth-first-search/ada/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Depth First Search](https://sampleprograms.io/projects/depth-first-search) in [Ada](https://sampleprograms.io/languages/ada)! Here, you'll find the source code for this program as well as a description of how the program works.
