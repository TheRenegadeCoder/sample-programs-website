...
- sources/programs/depth-first-search/beef/how-to-implement-the-solution.md
- sources/programs/depth-first-search/beef/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Depth First Search](/projects/depth-first-search) in [Beef](/languages/beef) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Depth First Search in [Beef](/languages/beef) was written by:
