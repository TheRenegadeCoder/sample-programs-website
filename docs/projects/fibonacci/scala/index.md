...
Welcome to the [Fibonacci](https://sampleprograms.io/projects/fibonacci) in [Scala](https://sampleprograms.io/languages/scala)! Here, you'll find the source code for this program as well as a description of how the program works.
