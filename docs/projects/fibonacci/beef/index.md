...
Welcome to the [Fibonacci](/projects/fibonacci) in [Beef](/languages/beef) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Fibonacci in [Beef](/languages/beef) was written by:
