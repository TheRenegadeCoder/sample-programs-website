...
Welcome to the [Fibonacci](/projects/fibonacci) in [Tcl](/languages/tcl) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Fibonacci in [Tcl](/languages/tcl) was written by:
