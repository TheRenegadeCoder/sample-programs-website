...
Welcome to the [Fibonacci](https://sampleprograms.io/projects/fibonacci) in [Bash](https://sampleprograms.io/languages/bash)! Here, you'll find the source code for this program as well as a description of how the program works.
