...
Welcome to the [Fibonacci](/projects/fibonacci) in [Bash](/languages/bash) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Fibonacci in [Bash](/languages/bash) was written by:
