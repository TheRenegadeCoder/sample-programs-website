...
Welcome to the [Fibonacci](/projects/fibonacci) in [PowerShell](/languages/powershell) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Fibonacci in [PowerShell](/languages/powershell) was written by:
