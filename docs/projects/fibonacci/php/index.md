...
Welcome to the [Fibonacci](/projects/fibonacci) in [PHP](/languages/php) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Fibonacci in [PHP](/languages/php) was written by:
