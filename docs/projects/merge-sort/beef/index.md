...
- sources/programs/merge-sort/beef/how-to-implement-the-solution.md
- sources/programs/merge-sort/beef/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Merge Sort](/projects/merge-sort) in [Beef](/languages/beef) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Merge Sort in [Beef](/languages/beef) was written by:
