...
Welcome to the [Merge Sort](https://sampleprograms.io/projects/merge-sort) in [COBOL](https://sampleprograms.io/languages/cobol)! Here, you'll find the source code for this program as well as a description of how the program works.
