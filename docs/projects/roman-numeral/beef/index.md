...
Welcome to the [Roman Numeral](https://sampleprograms.io/projects/roman-numeral) in [Beef](https://sampleprograms.io/languages/beef)! Here, you'll find the source code for this program as well as a description of how the program works.
