...
Welcome to the [Reverse String](/projects/reverse-string) in [Lua](/languages/lua) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Reverse String in [Lua](/languages/lua) was written by:
