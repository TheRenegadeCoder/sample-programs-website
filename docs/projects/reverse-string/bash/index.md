...
Welcome to the [Reverse String](/projects/reverse-string) in [Bash](/languages/bash) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Reverse String in [Bash](/languages/bash) was written by:
