...
Welcome to the [Reverse String](/projects/reverse-string) in [x86-64](/languages/x86-64) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Reverse String in [x86-64](/languages/x86-64) was written by:
