...
Welcome to the [Reverse String](/projects/reverse-string) in [AWK](/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Reverse String in [AWK](/languages/awk) was written by:
