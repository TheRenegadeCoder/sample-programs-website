...
Welcome to the [Reverse String](/projects/reverse-string) in [Beef](/languages/beef) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Reverse String in [Beef](/languages/beef) was written by:
