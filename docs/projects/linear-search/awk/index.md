...
Welcome to the [Linear Search](/projects/linear-search) in [AWK](/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Linear Search in [AWK](/languages/awk) was written by:
