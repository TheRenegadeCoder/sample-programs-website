...
Welcome to the [Linear Search](/projects/linear-search) in [C#](/languages/c-sharp) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Linear Search in [C#](/languages/c-sharp) was written by:
