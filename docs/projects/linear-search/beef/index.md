...
Welcome to the [Linear Search](/projects/linear-search) in [Beef](/languages/beef) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Linear Search in [Beef](/languages/beef) was written by:
