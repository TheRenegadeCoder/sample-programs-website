...
Welcome to the [Linear Search](https://sampleprograms.io/projects/linear-search) in [Perl](https://sampleprograms.io/languages/perl)! Here, you'll find the source code for this program as well as a description of how the program works.
