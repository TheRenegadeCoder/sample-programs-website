...
Welcome to the [Linear Search](/projects/linear-search) in [Haskell](/languages/haskell) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Linear Search in [Haskell](/languages/haskell) was written by:
