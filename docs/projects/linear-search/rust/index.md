...
Welcome to the [Linear Search](/projects/linear-search) in [Rust](/languages/rust) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Linear Search in [Rust](/languages/rust) was written by:
