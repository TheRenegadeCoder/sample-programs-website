...
Welcome to the [Linear Search](https://sampleprograms.io/projects/linear-search) in [Scala](https://sampleprograms.io/languages/scala)! Here, you'll find the source code for this program as well as a description of how the program works.
