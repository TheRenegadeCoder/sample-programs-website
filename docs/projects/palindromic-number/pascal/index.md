...
- sources/programs/palindromic-number/pascal/how-to-implement-the-solution.md
- sources/programs/palindromic-number/pascal/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Palindromic Number](https://sampleprograms.io/projects/palindromic-number) in [Pascal](https://sampleprograms.io/languages/pascal)! Here, you'll find the source code for this program as well as a description of how the program works.
