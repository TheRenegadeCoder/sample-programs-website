...
- sources/programs/palindromic-number/algol60/how-to-implement-the-solution.md
- sources/programs/palindromic-number/algol60/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Palindromic Number](https://sampleprograms.io/projects/palindromic-number) in [ALGOL 60](https://sampleprograms.io/languages/algol60) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Palindromic Number in [ALGOL 60](https://sampleprograms.io/languages/algol60) was written by:
