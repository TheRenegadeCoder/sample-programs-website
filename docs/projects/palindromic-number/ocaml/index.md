...
Welcome to the [Palindromic Number](https://sampleprograms.io/projects/palindromic-number) in [OCaml](https://sampleprograms.io/languages/ocaml) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Palindromic Number in [OCaml](https://sampleprograms.io/languages/ocaml) was written by:
