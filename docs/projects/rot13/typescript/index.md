...
Welcome to the [Rot13](https://sampleprograms.io/projects/rot13) in [TypeScript](https://sampleprograms.io/languages/typescript)! Here, you'll find the source code for this program as well as a description of how the program works.
