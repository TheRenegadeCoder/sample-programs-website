...
Welcome to the [Rot13](https://sampleprograms.io/projects/rot13) in [Ruby](https://sampleprograms.io/languages/ruby)! Here, you'll find the source code for this program as well as a description of how the program works.
