...
Welcome to the [Rot13](/projects/rot13) in [Commodore BASIC](/languages/commodore-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Rot13 in [Commodore BASIC](/languages/commodore-basic) was written by:
