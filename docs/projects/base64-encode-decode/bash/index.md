...
- bash
title: Base64 Encode Decode in Bash
title1: Base64 Encode
title2: Decode in Bash
---
...
- sources/programs/base64-encode-decode/bash/how-to-implement-the-solution.md
- sources/programs/base64-encode-decode/bash/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Base64 Encode Decode](https://sampleprograms.io/projects/base64-encode-decode) in [Bash](https://sampleprograms.io/languages/bash)! Here, you'll find the source code for this program as well as a description of how the program works.
