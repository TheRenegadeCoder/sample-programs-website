...
Welcome to the [Base64 Encode Decode](https://sampleprograms.io/projects/base64-encode-decode) in [Euphoria](https://sampleprograms.io/languages/euphoria)! Here, you'll find the source code for this program as well as a description of how the program works.
