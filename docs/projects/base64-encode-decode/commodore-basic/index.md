...
- sources/programs/base64-encode-decode/commodore-basic/how-to-implement-the-solution.md
- sources/programs/base64-encode-decode/commodore-basic/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Base64 Encode Decode](/projects/base64-encode-decode) in [Commodore BASIC](/languages/commodore-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Base64 Encode Decode in [Commodore BASIC](/languages/commodore-basic) was written by:
