...
- sources/programs/quick-sort/pascal/how-to-implement-the-solution.md
- sources/programs/quick-sort/pascal/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Quick Sort](https://sampleprograms.io/projects/quick-sort) in [Pascal](https://sampleprograms.io/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Quick Sort in [Pascal](https://sampleprograms.io/languages/pascal) was written by:
