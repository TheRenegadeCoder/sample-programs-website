...
Welcome to the [Quick Sort](/projects/quick-sort) in [Ruby](/languages/ruby) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Quick Sort in [Ruby](/languages/ruby) was written by:
