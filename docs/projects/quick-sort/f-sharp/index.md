...
Welcome to the [Quick Sort](/projects/quick-sort) in [F#](/languages/f-sharp) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Quick Sort in [F#](/languages/f-sharp) was written by:
