...
Welcome to the [Quick Sort](https://sampleprograms.io/projects/quick-sort) in [m4](https://sampleprograms.io/languages/m4)! Here, you'll find the source code for this program as well as a description of how the program works.
