...
Welcome to the [Quick Sort](https://sampleprograms.io/projects/quick-sort) in [Euphoria](https://sampleprograms.io/languages/euphoria)! Here, you'll find the source code for this program as well as a description of how the program works.
