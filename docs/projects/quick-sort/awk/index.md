...
Welcome to the [Quick Sort](/projects/quick-sort) in [AWK](/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Quick Sort in [AWK](/languages/awk) was written by:
