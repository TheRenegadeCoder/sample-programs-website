...
- sources/programs/quick-sort/c-plus-plus/how-to-implement-the-solution.md
- sources/programs/quick-sort/c-plus-plus/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Quick Sort](/projects/quick-sort) in [C++](/languages/c-plus-plus) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Quick Sort in [C++](/languages/c-plus-plus) was written by:
