...
Welcome to the [Quick Sort](/projects/quick-sort) in [Scala](/languages/scala) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Quick Sort in [Scala](/languages/scala) was written by:
