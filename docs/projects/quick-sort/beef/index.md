...
Welcome to the [Quick Sort](https://sampleprograms.io/projects/quick-sort) in [Beef](https://sampleprograms.io/languages/beef)! Here, you'll find the source code for this program as well as a description of how the program works.
