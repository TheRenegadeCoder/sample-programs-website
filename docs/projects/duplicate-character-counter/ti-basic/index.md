...
Welcome to the [Duplicate Character Counter](https://sampleprograms.io/projects/duplicate-character-counter) in [TI-BASIC](https://sampleprograms.io/languages/ti-basic)! Here, you'll find the source code for this program as well as a description of how the program works.
