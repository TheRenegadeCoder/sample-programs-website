...
Welcome to the [Duplicate Character Counter](https://sampleprograms.io/projects/duplicate-character-counter) in [Lua](https://sampleprograms.io/languages/lua)! Here, you'll find the source code for this program as well as a description of how the program works.
