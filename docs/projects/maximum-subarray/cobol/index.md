...
Welcome to the [Maximum Subarray](https://sampleprograms.io/projects/maximum-subarray) in [COBOL](https://sampleprograms.io/languages/cobol)! Here, you'll find the source code for this program as well as a description of how the program works.
