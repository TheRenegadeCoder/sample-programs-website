...
Welcome to the [Fraction Math](https://sampleprograms.io/projects/fraction-math) in [C#](https://sampleprograms.io/languages/c-sharp)! Here, you'll find the source code for this program as well as a description of how the program works.
