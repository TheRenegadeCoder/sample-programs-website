...
Welcome to the [Fraction Math](https://sampleprograms.io/projects/fraction-math) in [Tcl](https://sampleprograms.io/languages/tcl)! Here, you'll find the source code for this program as well as a description of how the program works.
