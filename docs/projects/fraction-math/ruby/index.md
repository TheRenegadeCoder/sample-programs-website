...
Welcome to the [Fraction Math](https://sampleprograms.io/projects/fraction-math) in [Ruby](https://sampleprograms.io/languages/ruby)! Here, you'll find the source code for this program as well as a description of how the program works.
