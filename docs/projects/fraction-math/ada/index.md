...
- sources/programs/fraction-math/ada/how-to-implement-the-solution.md
- sources/programs/fraction-math/ada/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Fraction Math](https://sampleprograms.io/projects/fraction-math) in [Ada](https://sampleprograms.io/languages/ada) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Fraction Math in [Ada](https://sampleprograms.io/languages/ada) was written by:
