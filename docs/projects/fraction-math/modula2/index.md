...
Welcome to the [Fraction Math](https://sampleprograms.io/projects/fraction-math) in [Modula-2](https://sampleprograms.io/languages/modula2)! Here, you'll find the source code for this program as well as a description of how the program works.
