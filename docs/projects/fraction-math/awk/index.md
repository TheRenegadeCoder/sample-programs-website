...
- sources/programs/fraction-math/awk/how-to-implement-the-solution.md
- sources/programs/fraction-math/awk/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Fraction Math](https://sampleprograms.io/projects/fraction-math) in [Awk](https://sampleprograms.io/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Fraction Math in [Awk](https://sampleprograms.io/languages/awk) was written by:
