...
Welcome to the [Zeckendorf](/projects/zeckendorf) in [AWK](/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Zeckendorf in [AWK](/languages/awk) was written by:
