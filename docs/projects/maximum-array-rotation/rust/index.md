...
- sources/programs/maximum-array-rotation/rust/how-to-implement-the-solution.md
- sources/programs/maximum-array-rotation/rust/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Maximum Array Rotation](https://sampleprograms.io/projects/maximum-array-rotation) in [Rust](https://sampleprograms.io/languages/rust)! Here, you'll find the source code for this program as well as a description of how the program works.
...
Maximum Array Rotation in [Rust](https://sampleprograms.io/languages/rust) was written by:
