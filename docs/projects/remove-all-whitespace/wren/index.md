...
Welcome to the [Remove All Whitespace](https://sampleprograms.io/projects/remove-all-whitespace) in [Wren](https://sampleprograms.io/languages/wren)! Here, you'll find the source code for this program as well as a description of how the program works.
