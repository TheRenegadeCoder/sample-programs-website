...
Welcome to the [Remove All Whitespace](https://sampleprograms.io/projects/remove-all-whitespace) in [Kotlin](https://sampleprograms.io/languages/kotlin)! Here, you'll find the source code for this program as well as a description of how the program works.
