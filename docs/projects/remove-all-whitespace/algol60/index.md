...
Welcome to the [Remove All Whitespace](/projects/remove-all-whitespace) in [ALGOL 60](/languages/algol60) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Remove All Whitespace in [ALGOL 60](/languages/algol60) was written by:
