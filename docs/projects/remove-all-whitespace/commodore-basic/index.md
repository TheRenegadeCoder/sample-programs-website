...
Welcome to the [Remove All Whitespace](/projects/remove-all-whitespace) in [Commodore BASIC](/languages/commodore-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Remove All Whitespace in [Commodore BASIC](/languages/commodore-basic) was written by:
