...
Welcome to the [Minimum Spanning Tree](/projects/minimum-spanning-tree) in [Pascal](/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Minimum Spanning Tree in [Pascal](/languages/pascal) was written by:
