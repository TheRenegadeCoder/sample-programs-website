...
Welcome to the [Minimum Spanning Tree](/projects/minimum-spanning-tree) in [ALGOL 60](/languages/algol60) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Minimum Spanning Tree in [ALGOL 60](/languages/algol60) was written by:
