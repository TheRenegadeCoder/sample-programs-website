...
- sources/programs/minimum-spanning-tree/php/how-to-implement-the-solution.md
- sources/programs/minimum-spanning-tree/php/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Minimum Spanning Tree](/projects/minimum-spanning-tree) in [PHP](/languages/php) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Minimum Spanning Tree in [PHP](/languages/php) was written by:
