...
Welcome to the [Binary Search](https://sampleprograms.io/projects/binary-search) in [Beef](https://sampleprograms.io/languages/beef)! Here, you'll find the source code for this program as well as a description of how the program works.
