...
- sources/programs/binary-search/mathematica/how-to-implement-the-solution.md
- sources/programs/binary-search/mathematica/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Binary Search](/projects/binary-search) in [Mathematica](/languages/mathematica) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Binary Search in [Mathematica](/languages/mathematica) was written by:
