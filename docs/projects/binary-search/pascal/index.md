...
- sources/programs/binary-search/pascal/how-to-implement-the-solution.md
- sources/programs/binary-search/pascal/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Binary Search](https://sampleprograms.io/projects/binary-search) in [Pascal](https://sampleprograms.io/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Binary Search in [Pascal](https://sampleprograms.io/languages/pascal) was written by:
