...
Welcome to the [Binary Search](https://sampleprograms.io/projects/binary-search) in [Tcl](https://sampleprograms.io/languages/tcl)! Here, you'll find the source code for this program as well as a description of how the program works.
