...
- sources/programs/binary-search/ada/how-to-implement-the-solution.md
- sources/programs/binary-search/ada/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Binary Search](https://sampleprograms.io/projects/binary-search) in [Ada](https://sampleprograms.io/languages/ada)! Here, you'll find the source code for this program as well as a description of how the program works.
