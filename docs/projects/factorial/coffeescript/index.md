...
Welcome to the [Factorial](https://sampleprograms.io/projects/factorial) in [CoffeeScript](https://sampleprograms.io/languages/coffeescript)! Here, you'll find the source code for this program as well as a description of how the program works.
