...
Welcome to the [Factorial](/projects/factorial) in [Crystal](/languages/crystal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Factorial in [Crystal](/languages/crystal) was written by:
