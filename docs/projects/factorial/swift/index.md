...
Welcome to the [Factorial](/projects/factorial) in [Swift](/languages/swift) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Factorial in [Swift](/languages/swift) was written by:
