...
Welcome to the [Factorial](/projects/factorial) in [Visual Basic](/languages/visual-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Factorial in [Visual Basic](/languages/visual-basic) was written by:
