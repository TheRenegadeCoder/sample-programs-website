...
Welcome to the [Factorial](https://sampleprograms.io/projects/factorial) in [Tcl](https://sampleprograms.io/languages/tcl)! Here, you'll find the source code for this program as well as a description of how the program works.
