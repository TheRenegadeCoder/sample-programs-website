...
Welcome to the [Factorial](/projects/factorial) in [Wren](/languages/wren) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Factorial in [Wren](/languages/wren) was written by:
