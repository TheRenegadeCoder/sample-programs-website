...
Welcome to the [Factorial](/projects/factorial) in [C#](/languages/c-sharp) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Factorial in [C#](/languages/c-sharp) was written by:
