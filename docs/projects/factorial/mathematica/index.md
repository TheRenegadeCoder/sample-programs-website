...
Welcome to the [Factorial](/projects/factorial) in [Mathematica](/languages/mathematica) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Factorial in [Mathematica](/languages/mathematica) was written by:
