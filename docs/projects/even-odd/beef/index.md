...
Welcome to the [Even Odd](/projects/even-odd) in [Beef](/languages/beef) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Even Odd in [Beef](/languages/beef) was written by:
