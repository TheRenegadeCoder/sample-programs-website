...
- sources/programs/even-odd/cobol/how-to-implement-the-solution.md
- sources/programs/even-odd/cobol/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Even Odd](/projects/even-odd) in [COBOL](/languages/cobol) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Even Odd in [COBOL](/languages/cobol) was written by:
