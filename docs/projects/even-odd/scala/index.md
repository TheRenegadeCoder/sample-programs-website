...
Welcome to the [Even Odd](/projects/even-odd) in [Scala](/languages/scala) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Even Odd in [Scala](/languages/scala) was written by:
