...
Welcome to the [Even Odd](/projects/even-odd) in [Wren](/languages/wren) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Even Odd in [Wren](/languages/wren) was written by:
