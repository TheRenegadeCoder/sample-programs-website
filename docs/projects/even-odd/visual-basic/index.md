...
Welcome to the [Even Odd](/projects/even-odd) in [Visual Basic](/languages/visual-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Even Odd in [Visual Basic](/languages/visual-basic) was written by:
