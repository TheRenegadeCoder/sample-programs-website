...
Welcome to the [Even Odd](/projects/even-odd) in [Swift](/languages/swift) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Even Odd in [Swift](/languages/swift) was written by:
