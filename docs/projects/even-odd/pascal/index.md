...
Welcome to the [Even Odd](/projects/even-odd) in [Pascal](/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Even Odd in [Pascal](/languages/pascal) was written by:
