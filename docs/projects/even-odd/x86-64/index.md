...
Welcome to the [Even Odd](https://sampleprograms.io/projects/even-odd) in [x86-64](https://sampleprograms.io/languages/x86-64)! Here, you'll find the source code for this program as well as a description of how the program works.
