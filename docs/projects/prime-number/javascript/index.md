...
Welcome to the [Prime Number](https://sampleprograms.io/projects/prime-number) in [JavaScript](https://sampleprograms.io/languages/javascript)! Here, you'll find the source code for this program as well as a description of how the program works.
