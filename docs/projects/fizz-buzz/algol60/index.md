...
Welcome to the [Fizz Buzz](https://sampleprograms.io/projects/fizz-buzz) in [ALGOL 60](https://sampleprograms.io/languages/algol60)! Here, you'll find the source code for this program as well as a description of how the program works.
