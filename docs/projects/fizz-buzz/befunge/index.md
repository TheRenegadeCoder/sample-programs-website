...
- sources/programs/fizz-buzz/befunge/how-to-implement-the-solution.md
- sources/programs/fizz-buzz/befunge/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Fizz Buzz](https://sampleprograms.io/projects/fizz-buzz) in [Befunge](https://sampleprograms.io/languages/befunge)! Here, you'll find the source code for this program as well as a description of how the program works.
