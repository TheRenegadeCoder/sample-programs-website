...
- sources/programs/fizz-buzz/fetlang/how-to-implement-the-solution.md
- sources/programs/fizz-buzz/fetlang/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Fizz Buzz](https://sampleprograms.io/projects/fizz-buzz) in [Fetlang](https://sampleprograms.io/languages/fetlang) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Fizz Buzz in [Fetlang](https://sampleprograms.io/languages/fetlang) was written by:
