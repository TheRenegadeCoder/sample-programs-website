...
Welcome to the [LCS](https://sampleprograms.io/projects/lcs) in [Go](https://sampleprograms.io/languages/go) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
[LCS](https://sampleprograms.io/projects/lcs) in [Go](https://sampleprograms.io/languages/go) was written by:
