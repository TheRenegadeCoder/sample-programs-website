...
Welcome to the [Bubble Sort](/projects/bubble-sort) in [AWK](/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Bubble Sort in [AWK](/languages/awk) was written by:
