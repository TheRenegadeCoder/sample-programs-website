...
- job-sequencing
- pascal
title: Job Sequencing in Pascal
---
...
- sources/programs/job-sequencing/pascal/how-to-implement-the-solution.md
- sources/programs/job-sequencing/pascal/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Job Sequencing](https://sampleprograms.io/projects/job-sequencing) in [Pascal](https://sampleprograms.io/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Job Sequencing in [Pascal](https://sampleprograms.io/languages/pascal) was written by:
