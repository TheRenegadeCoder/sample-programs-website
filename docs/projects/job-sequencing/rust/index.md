...
- sources/programs/job-sequencing/rust/how-to-implement-the-solution.md
- sources/programs/job-sequencing/rust/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Job Sequencing](/projects/job-sequencing) in [Rust](/languages/rust) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Job Sequencing in [Rust](/languages/rust) was written by:
