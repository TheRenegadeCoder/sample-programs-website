...
Welcome to the [Hello World](/projects/hello-world) in [Solidity](/languages/solidity) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Solidity](/languages/solidity) was written by:
