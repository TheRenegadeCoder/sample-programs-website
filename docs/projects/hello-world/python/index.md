...
Welcome to the [Hello World](/projects/hello-world) in [Python](/languages/python) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Python](/languages/python) was written by:
