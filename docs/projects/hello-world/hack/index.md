...
Welcome to the [Hello World](/projects/hello-world) in [Hack](/languages/hack) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Hack](/languages/hack) was written by:
