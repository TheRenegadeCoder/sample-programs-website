...
Welcome to the [Hello World](/projects/hello-world) in [Befunge](/languages/befunge) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Befunge](/languages/befunge) was written by:
