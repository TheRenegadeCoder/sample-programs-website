...
Welcome to the [Hello World](/projects/hello-world) in [Lisp](/languages/lisp) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Lisp](/languages/lisp) was written by:
