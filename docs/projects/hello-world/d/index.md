...
Welcome to the [Hello World](/projects/hello-world) in [D](/languages/d) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [D](/languages/d) was written by:
