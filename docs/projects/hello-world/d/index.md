...
Welcome to the [Hello World](https://sampleprograms.io/projects/hello-world) in [D](https://sampleprograms.io/languages/d)! Here, you'll find the source code for this program as well as a description of how the program works.
