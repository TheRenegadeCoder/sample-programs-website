...
- sources/programs/hello-world/r/how-to-implement-the-solution.md
- sources/programs/hello-world/r/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Hello World](/projects/hello-world) in [R](/languages/r) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [R](/languages/r) was written by:
