...
Welcome to the [Hello World](/projects/hello-world) in [Wren](/languages/wren) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Wren](/languages/wren) was written by:
