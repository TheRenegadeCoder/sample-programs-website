...
- sources/programs/hello-world/typescript/how-to-implement-the-solution.md
- sources/programs/hello-world/typescript/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Hello World](https://sampleprograms.io/projects/hello-world) in [TypeScript](https://sampleprograms.io/languages/typescript)! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [TypeScript](https://sampleprograms.io/languages/typescript) was written by:
