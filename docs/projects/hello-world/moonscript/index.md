...
Welcome to the [Hello World](https://sampleprograms.io/projects/hello-world) in [MoonScript](https://sampleprograms.io/languages/moonscript)! Here, you'll find the source code for this program as well as a description of how the program works.
