...
Welcome to the [Hello World](/projects/hello-world) in [Scala](/languages/scala) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Scala](/languages/scala) was written by:
