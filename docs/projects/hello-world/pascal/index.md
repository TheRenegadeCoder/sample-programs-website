...
Welcome to the [Hello World](/projects/hello-world) in [Pascal](/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Pascal](/languages/pascal) was written by:
