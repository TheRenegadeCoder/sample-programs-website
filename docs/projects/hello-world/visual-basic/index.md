...
Welcome to the [Hello World](/projects/hello-world) in [Visual Basic](/languages/visual-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Visual Basic](/languages/visual-basic) was written by:
