...
Welcome to the [Hello World](/projects/hello-world) in [PowerShell](/languages/powershell) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [PowerShell](/languages/powershell) was written by:
