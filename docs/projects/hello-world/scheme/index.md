...
Welcome to the [Hello World](/projects/hello-world) in [Scheme](/languages/scheme) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Hello World in [Scheme](/languages/scheme) was written by:
