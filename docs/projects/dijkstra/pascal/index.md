...
- sources/programs/dijkstra/pascal/how-to-implement-the-solution.md
- sources/programs/dijkstra/pascal/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Dijkstra](https://sampleprograms.io/projects/dijkstra) in [Pascal](https://sampleprograms.io/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Dijkstra in [Pascal](https://sampleprograms.io/languages/pascal) was written by:
