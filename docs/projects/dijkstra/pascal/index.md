...
Welcome to the [Dijkstra](/projects/dijkstra) in [Pascal](/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Dijkstra in [Pascal](/languages/pascal) was written by:
