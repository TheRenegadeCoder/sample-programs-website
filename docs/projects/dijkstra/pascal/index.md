...
Welcome to the [Dijkstra](https://sampleprograms.io/projects/dijkstra) in [Pascal](https://sampleprograms.io/languages/pascal)! Here, you'll find the source code for this program as well as a description of how the program works.
