...
- sources/programs/dijkstra/powershell/how-to-implement-the-solution.md
- sources/programs/dijkstra/powershell/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Dijkstra](/projects/dijkstra) in [PowerShell](/languages/powershell) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Dijkstra in [PowerShell](/languages/powershell) was written by:
