...
Welcome to the [Dijkstra](https://sampleprograms.io/projects/dijkstra) in [Euphoria](https://sampleprograms.io/languages/euphoria)! Here, you'll find the source code for this program as well as a description of how the program works.
