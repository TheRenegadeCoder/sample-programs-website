...
- sources/programs/dijkstra/m4/how-to-implement-the-solution.md
- sources/programs/dijkstra/m4/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Dijkstra](https://sampleprograms.io/projects/dijkstra) in [m4](https://sampleprograms.io/languages/m4)! Here, you'll find the source code for this program as well as a description of how the program works.
