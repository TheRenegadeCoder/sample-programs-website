...
Welcome to the [Dijkstra](https://sampleprograms.io/projects/dijkstra) in [Ruby](https://sampleprograms.io/languages/ruby) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Dijkstra in [Ruby](https://sampleprograms.io/languages/ruby) was written by:
