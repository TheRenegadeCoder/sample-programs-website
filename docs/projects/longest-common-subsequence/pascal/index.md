...
Welcome to the [Longest Common Subsequence](https://sampleprograms.io/projects/longest-common-subsequence) in [Pascal](https://sampleprograms.io/languages/pascal)! Here, you'll find the source code for this program as well as a description of how the program works.
