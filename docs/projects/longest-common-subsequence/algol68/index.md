...
Welcome to the [Longest Common Subsequence](/projects/longest-common-subsequence) in [ALGOL 68](/languages/algol68) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Longest Common Subsequence in [ALGOL 68](/languages/algol68) was written by:
