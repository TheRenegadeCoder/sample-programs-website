...
Welcome to the [File Input Output](https://sampleprograms.io/projects/file-input-output) in [COBOL](https://sampleprograms.io/languages/cobol)! Here, you'll find the source code for this program as well as a description of how the program works.
