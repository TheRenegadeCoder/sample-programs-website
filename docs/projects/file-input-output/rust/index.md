...
- sources/programs/file-input-output/rust/how-to-implement-the-solution.md
- sources/programs/file-input-output/rust/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [File Input Output](/projects/file-input-output) in [Rust](/languages/rust) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
File Input Output in [Rust](/languages/rust) was written by:
