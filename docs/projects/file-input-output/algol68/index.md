...
Welcome to the [File Input Output](/projects/file-input-output) in [ALGOL 68](/languages/algol68) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
File Input Output in [ALGOL 68](/languages/algol68) was written by:
