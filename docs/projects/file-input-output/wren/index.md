...
Welcome to the [File Input Output](/projects/file-input-output) in [Wren](/languages/wren) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
File Input Output in [Wren](/languages/wren) was written by:
