...
Welcome to the [File Input Output](/projects/file-input-output) in [GNU Make](/languages/gnu-make) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
File Input Output in [GNU Make](/languages/gnu-make) was written by:
