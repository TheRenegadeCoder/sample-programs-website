...
Welcome to the [Capitalize](/projects/capitalize) in [C](/languages/c) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Capitalize in [C](/languages/c) was written by:
