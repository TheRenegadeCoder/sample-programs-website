...
Welcome to the [Capitalize](https://sampleprograms.io/projects/capitalize) in [Groovy](https://sampleprograms.io/languages/groovy)! Here, you'll find the source code for this program as well as a description of how the program works.
