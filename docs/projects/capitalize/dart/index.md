...
- sources/programs/capitalize/dart/how-to-implement-the-solution.md
- sources/programs/capitalize/dart/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Capitalize](https://sampleprograms.io/projects/capitalize) in [Dart](https://sampleprograms.io/languages/dart)! Here, you'll find the source code for this program as well as a description of how the program works.
