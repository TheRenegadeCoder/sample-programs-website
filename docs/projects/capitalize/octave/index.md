...
Welcome to the [Capitalize](https://sampleprograms.io/projects/capitalize) in [Octave](https://sampleprograms.io/languages/octave)! Here, you'll find the source code for this program as well as a description of how the program works.
