...
Welcome to the [Capitalize](https://sampleprograms.io/projects/capitalize) in [Brainfuck](https://sampleprograms.io/languages/brainfuck)! Here, you'll find the source code for this program as well as a description of how the program works.
