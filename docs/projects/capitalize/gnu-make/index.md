...
- sources/programs/capitalize/gnu-make/how-to-implement-the-solution.md
- sources/programs/capitalize/gnu-make/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Capitalize](https://sampleprograms.io/projects/capitalize) in [GNU Make](https://sampleprograms.io/languages/gnu-make)! Here, you'll find the source code for this program as well as a description of how the program works.
