...
Welcome to the [Capitalize](/projects/capitalize) in [TI-BASIC](/languages/ti-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Capitalize in [TI-BASIC](/languages/ti-basic) was written by:
