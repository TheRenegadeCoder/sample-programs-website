...
Welcome to the [Longest Palindromic Substring](/projects/longest-palindromic-substring) in [F#](/languages/f-sharp) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Longest Palindromic Substring in [F#](/languages/f-sharp) was written by:
