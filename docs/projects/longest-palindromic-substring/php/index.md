...
- sources/programs/longest-palindromic-substring/php/how-to-implement-the-solution.md
- sources/programs/longest-palindromic-substring/php/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Longest Palindromic Substring](/projects/longest-palindromic-substring) in [PHP](/languages/php) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Longest Palindromic Substring in [PHP](/languages/php) was written by:
