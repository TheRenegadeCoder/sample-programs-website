...
Welcome to the [Selection Sort](https://sampleprograms.io/projects/selection-sort) in [TypeScript](https://sampleprograms.io/languages/typescript)! Here, you'll find the source code for this program as well as a description of how the program works.
