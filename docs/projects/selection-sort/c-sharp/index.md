...
Welcome to the [Selection Sort](https://sampleprograms.io/projects/selection-sort) in [C#](https://sampleprograms.io/languages/c-sharp)! Here, you'll find the source code for this program as well as a description of how the program works.
...
Selection Sort in [C#](https://sampleprograms.io/languages/c-sharp) was written by:
