...
- sources/programs/selection-sort/c/how-to-implement-the-solution.md
- sources/programs/selection-sort/c/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Selection Sort](https://sampleprograms.io/projects/selection-sort) in [C](https://sampleprograms.io/languages/c)! Here, you'll find the source code for this program as well as a description of how the program works.
