...
Welcome to the [Longest Word](/projects/longest-word) in [Commodore BASIC](/languages/commodore-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Longest Word in [Commodore BASIC](/languages/commodore-basic) was written by:
