...
Welcome to the [Longest Word](https://sampleprograms.io/projects/longest-word) in [Ada](https://sampleprograms.io/languages/ada) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Longest Word in [Ada](https://sampleprograms.io/languages/ada) was written by:
