...
- sources/programs/longest-word/brainfuck/how-to-implement-the-solution.md
- sources/programs/longest-word/brainfuck/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Longest Word](/projects/longest-word) in [Brainfuck](/languages/brainfuck) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Longest Word in [Brainfuck](/languages/brainfuck) was written by:
