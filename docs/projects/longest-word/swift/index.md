...
Welcome to the [Longest Word](https://sampleprograms.io/projects/longest-word) in [Swift](https://sampleprograms.io/languages/swift)! Here, you'll find the source code for this program as well as a description of how the program works.
