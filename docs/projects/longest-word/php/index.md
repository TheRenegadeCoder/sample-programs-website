...
Welcome to the [Longest Word](/projects/longest-word) in [PHP](/languages/php) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Longest Word in [PHP](/languages/php) was written by:
