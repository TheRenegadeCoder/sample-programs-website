...
Welcome to the [Longest Word](/projects/longest-word) in [Tcl](/languages/tcl) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Longest Word in [Tcl](/languages/tcl) was written by:
