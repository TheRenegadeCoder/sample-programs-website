...
Welcome to the [Convex Hull](/projects/convex-hull) in [C](/languages/c) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Convex Hull in [C](/languages/c) was written by:
