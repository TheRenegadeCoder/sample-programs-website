...
Welcome to the [Convex Hull](/projects/convex-hull) in [Visual Basic](/languages/visual-basic) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Convex Hull in [Visual Basic](/languages/visual-basic) was written by:
