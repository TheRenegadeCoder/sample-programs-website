...
Welcome to the [Convex Hull](https://sampleprograms.io/projects/convex-hull) in [Tcl](https://sampleprograms.io/languages/tcl)! Here, you'll find the source code for this program as well as a description of how the program works.
