...
Welcome to the [Convex Hull](https://sampleprograms.io/projects/convex-hull) in [JavaScript](https://sampleprograms.io/languages/javascript)! Here, you'll find the source code for this program as well as a description of how the program works.
