...
Welcome to the [Convex Hull](/projects/convex-hull) in [Python](/languages/python) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Convex Hull in [Python](/languages/python) was written by:
