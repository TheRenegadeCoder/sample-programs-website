...
- sources/programs/convex-hull/php/how-to-implement-the-solution.md
- sources/programs/convex-hull/php/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Convex Hull](/projects/convex-hull) in [PHP](/languages/php) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Convex Hull in [PHP](/languages/php) was written by:
