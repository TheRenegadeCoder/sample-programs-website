...
Welcome to the [Quine](https://sampleprograms.io/projects/quine) in [Cython](https://sampleprograms.io/languages/cython)! Here, you'll find the source code for this program as well as a description of how the program works.
