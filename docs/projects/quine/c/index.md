...
Welcome to the [Quine](/projects/quine) in [C](/languages/c) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Quine in [C](/languages/c) was written by:
