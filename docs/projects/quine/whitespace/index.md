...
Welcome to the [Quine](https://sampleprograms.io/projects/quine) in [Whitespace](https://sampleprograms.io/languages/whitespace)! Here, you'll find the source code for this program as well as a description of how the program works.
