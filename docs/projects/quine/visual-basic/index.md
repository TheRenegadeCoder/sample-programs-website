...
Welcome to the [Quine](https://sampleprograms.io/projects/quine) in [Visual Basic](https://sampleprograms.io/languages/visual-basic)! Here, you'll find the source code for this program as well as a description of how the program works.
