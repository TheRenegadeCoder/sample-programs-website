...
- sources/programs/transpose-matrix/rust/how-to-implement-the-solution.md
- sources/programs/transpose-matrix/rust/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Transpose Matrix](https://sampleprograms.io/projects/transpose-matrix) in [Rust](https://sampleprograms.io/languages/rust)! Here, you'll find the source code for this program as well as a description of how the program works.
