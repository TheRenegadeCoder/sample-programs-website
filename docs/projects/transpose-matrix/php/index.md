...
Welcome to the [Transpose Matrix](https://sampleprograms.io/projects/transpose-matrix) in [PHP](https://sampleprograms.io/languages/php)! Here, you'll find the source code for this program as well as a description of how the program works.
