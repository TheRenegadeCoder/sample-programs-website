...
Welcome to the [Transpose Matrix](https://sampleprograms.io/projects/transpose-matrix) in [ALGOL 60](https://sampleprograms.io/languages/algol60)! Here, you'll find the source code for this program as well as a description of how the program works.
