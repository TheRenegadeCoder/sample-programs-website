...
Welcome to the [Transpose Matrix](/projects/transpose-matrix) in [Pascal](/languages/pascal) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Transpose Matrix in [Pascal](/languages/pascal) was written by:
