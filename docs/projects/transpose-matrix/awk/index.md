...
Welcome to the [Transpose Matrix](/projects/transpose-matrix) in [AWK](/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Transpose Matrix in [AWK](/languages/awk) was written by:
