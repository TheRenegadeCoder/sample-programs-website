...
Welcome to the [Insertion Sort](/projects/insertion-sort) in [Rust](/languages/rust) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Insertion Sort in [Rust](/languages/rust) was written by:
