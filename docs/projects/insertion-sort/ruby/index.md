...
Welcome to the [Insertion Sort](https://sampleprograms.io/projects/insertion-sort) in [Ruby](https://sampleprograms.io/languages/ruby)! Here, you'll find the source code for this program as well as a description of how the program works.
