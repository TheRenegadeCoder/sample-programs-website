...
Welcome to the [Insertion Sort](/projects/insertion-sort) in [Perl](/languages/perl) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Insertion Sort in [Perl](/languages/perl) was written by:
