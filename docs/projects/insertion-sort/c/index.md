...
- sources/programs/insertion-sort/c/how-to-implement-the-solution.md
- sources/programs/insertion-sort/c/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Insertion Sort](/projects/insertion-sort) in [C](/languages/c) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Insertion Sort in [C](/languages/c) was written by:
