...
Welcome to the [Insertion Sort](/projects/insertion-sort) in [AWK](/languages/awk) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Insertion Sort in [AWK](/languages/awk) was written by:
