...
- sources/programs/insertion-sort/fortran/how-to-implement-the-solution.md
- sources/programs/insertion-sort/fortran/how-to-run-the-solution.md

See .github/CONTRIBUTING.md for further details.
-->

Welcome to the [Insertion Sort](https://sampleprograms.io/projects/insertion-sort) in [Fortran](https://sampleprograms.io/languages/fortran) page! Here, you'll find the source code for this program as well as a description of how the program works.
...
Insertion Sort in [Fortran](https://sampleprograms.io/languages/fortran) was written by:
