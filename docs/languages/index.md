...
Welcome to the Languages page! Here, you'll find a list of all of the languages represented in the collection. At this time, there are 158 languages, of which 157 are tested, 1 is untestable, and 1409 code snippets.
...
<table class="bar-graph">
    ...
    <tr>
        ...
        <td class="bar-graph"><div style="width: 38.04%; background-color: #B07219;"></div></td> 
    </tr>
    ...
    <tr>
        ...
        <td class="bar-graph"><div style="width: 12.03%; background-color: #B845FC;"></div></td> 
    </tr>
...
The 'A' collection contains 6 languages, of which 6 are tested, and 104 code snippets.

- [Ada](https://sampleprograms.io/languages/ada) (3 code snippets)
- [Agda](https://sampleprograms.io/languages/agda) (2 code snippets)
- [ALGOL 60](https://sampleprograms.io/languages/algol60) (18 code snippets)
...
The 'F' collection contains 12 languages, of which 12 are tested, and 47 code snippets.

- [F#](https://sampleprograms.io/languages/f-sharp) (11 code snippets)
...
The 'J' collection contains 4 languages, of which 4 are tested, and 80 code snippets.

- [Janet](https://sampleprograms.io/languages/janet) (3 code snippets)
- [Java](https://sampleprograms.io/languages/java) (29 code snippets)
...
The 'P' collection contains 14 languages, of which 14 are tested, and 201 code snippets.
