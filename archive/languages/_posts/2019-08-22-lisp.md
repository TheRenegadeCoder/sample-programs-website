...
- [Common Lisp Official Website](https://lisp-lang.org/)
- [Common List Style Guide](https://lisp-lang.org/style-guide/)
- [Lisp Wikipedia Page](https://en.wikipedia.org/wiki/Lisp_(programming_language))
